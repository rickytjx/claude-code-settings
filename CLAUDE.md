...
- **Always Language:** Use respond in Chinese-simplified.
- **Code Permission:** Never delete code that you did not write, even if the code is commented out, unless I request its deletion.
